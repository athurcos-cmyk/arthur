...
* **As 3 Camadas da Parede Cardíaca (de fora para dentro):**
    1. **Epicárdio:** A camada mais externa, que também é a camada visceral do pericárdio. <br>
    2. **Miocárdio:** A camada do meio, composta pelo músculo estriado cardíaco. É a mais espessa e responsável pela contração do coração. <br>
    3. **Endocárdio:** A camada mais interna, que reveste as câmaras e as válvulas do coração. <br>
...
* **A Sequência do Impulso:**
    1. **Nó Sinoatrial (SA):** O "marcapasso natural", localizado no átrio direito, onde o impulso começa. <br>
    2. **Nó Atrioventricular (AV):** Recebe o impulso dos átrios e o retarda por um instante para garantir que os ventrículos se encham de sangue. <br>
    3. **Feixe de His e Fibras de Purkinje:** Conduzem o impulso rapidamente por todo o miocárdio ventricular, causando uma contração forte e sincronizada. <br>
* **Relação com o Eletrocardiograma (ECG):**
    * **Onda P:** Representa a **despolarização dos átrios**. <br>
    * **Complexo QRS:** Representa a **despolarização dos ventrículos**. <br>
    * **Onda T:** Representa a **repolarização dos ventrículos**. <br>
...
* **Os Sons do Coração (Bulhas Cardíacas):**
    * **B1 ("lub"):** Ocorre no **início da sístole**. É causado pelo **fechamento das válvulas atrioventriculares** (Mitral e Tricúspide). <br>
    * **B2 ("tá"):** Ocorre no **início da diástole**. É causado pelo **fechamento das válvulas semilunares** (Aórtica e Pulmonar). <br>
...
* **Débito Cardíaco (DC):** É o volume total de sangue bombeado pelo coração em **UM MINUTO**. A fórmula é: **DC = VS x FC**. <br>
