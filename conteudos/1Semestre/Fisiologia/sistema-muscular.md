...
* **Retículo Endoplasmático**: chamado de **Retículo Sarcoplasmático** (armazena $\text{Ca}^{2+}$). <br>
* **Citoplasma**: chamado de **sarcoplasma** onde tem miofilamentos constituídos de **actina** e **miosina**. <br>
...
* (Espaço reservado para o estudo mais profundo da estrutura). <br>
...
* ATP <br>
* Fosfocreatina <br>
* Fermentação láctea <br>
* Respiração celular <br>
* (Se movimentar gasta muita energia). <br>
...
* É o Miocárdio. <br>
* Tem **estímulo próprio** (automatismo). <br>
* Células ramificadas com 1 ou 2 núcleos. <br>
* Possui **discos intercalares** (junções comunicantes). <br>

### Músculo Liso <br>
* Tem microfilamentos **não alinhados** (por isso não tem estrias). <br>
* Possui apenas 1 núcleo. <br>
* **Não possui túbulos T**. <br>
* Normalmente fazem **movimento peristáltico**. <br>

### Regeneração <br>
* **Cardíaco**: não regenera. <br>
* **Esquelético**: regenera pouco. <br>
* **Liso**: regenera (maior capacidade de hiperplasia/divisão celular). <br>