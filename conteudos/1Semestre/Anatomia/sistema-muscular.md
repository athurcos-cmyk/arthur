...
### Classificação histológica/topográfica <br>

* **Estriado esquelético** → voluntário; estriado; fixado ao esqueleto (pelo menos em uma extremidade). <br>
...
* **Fáscia muscular** → bainha de tecido conjuntivo fibroso que envolve o ventre muscular; mantém fibras próximas, **facilita o deslizamento** e funciona como **bainha elástica de contenção**. <br>
* **Tendão** → tecido conjuntivo denso, resistente, **não elástico**, geralmente cilíndrico (“fita”); fixa músculo ao osso. quando apresentam aspecto laminas são chamados de aponeuroses. <br>
    * **Aponeurose** → variante laminar do tendão (larga/achatada), também para fixação. <br>
...
![Origem e Inserção Muscular](https://i.imgur.com/tuDO0al.png) <br>
