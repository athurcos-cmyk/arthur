...
* **Sistema de alavancas:** sistema esquelético = **passivo**; sistema muscular = **ativo**. <br>
* **Armazenamento de íons:** **cálcio** e **fósforo**. <br>
...
* **Ossos longos** — todo osso que tem **comprimento maior que largura e espessura**. Ossos do esqueleto apendicular (Tíbia, Úmero). <br>
    * Tem algumas extremidades e um corpo:
        * **diáfise**: <br>
            * No interior da Diáfise tem um espaço denominada de **cavidade medular**, que é preenchido por medula óssea que pode ser rubra ou flava. Responsável pela **produção ativa de células do sangue**.
        * **epífise proximal**
        * **epífise distal**
        * ⚠️ **Epífise = extremidade proximal ou distal de um osso longo (não é a distância entre elas).**
            * Nos ossos longos em desenvolvimento entre a epífise e a diáfise existe um disco cartilagíneo denominado de **disco epifisial**, responsável pelo **crescimento em comprimento** desses ossos. <br>

* **Ossos alongados** - Apresentam o comprimento maior que a largura e a espessura, porém **não encontramos epífises, diáfise e cavidade medular**. Ex. **clavícula e costela**. <br>
* **Ossos planos** — largura e comprimento semelhantes, maiores que a espessura. <br>
* **Ossos curtos** — semelhantes a um cubo. EX: **ossos carpais e tarsais**. <br>
* **Ossos irregulares** — não possuem forma geométrica bem definida. Ex: **vértebras, osso temporal**. <br>
* **Ossos pneumáticos** - Apresentam cavidade preenchida com ar:
    * frontal
    * maxila
    * etmóide
    * esfenóide
...
* Constituído por dois folhetos:
    * **interno = Camada osteogênica**:
        * forma osso
        * crescimento do ósseo
        * reparação de fraturas
        * nutrição do osso
    * **externo**:
        * inserção de ligamentos e tendões musculares <br>
